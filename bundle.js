...
/***/ function(module, exports, __webpack_require__) {
	...
	var _knobs = __webpack_require__(9);

	var Knobs = _interopRequireWildcard(_knobs);

	var _knob = __webpack_require__(11);
	...
	var _voice = __webpack_require__(24);

	var _voice2 = _interopRequireDefault(_voice);

	var _sequencer = __webpack_require__(27);
	...
	var _led = __webpack_require__(29);
	...
	var _oscilloscope = __webpack_require__(26);
	...
	var _oscillator = __webpack_require__(32);
	...
	var title_label = new _label2.default(canvas, 'V0.1', 10).setPos(810, 70).setAlign('right');
	...
	// OSC2
	var osc2 = new _oscillator2.default(canvas, v2, 'OSC2').setPos(80, 185);

	// Sequencer
	var sequencer = new _sequencer2.default().connect(v1).connect(v2).setBPM(200);

	// Default notes
	sequencer.seq.setNote(0, _notes2.default.note('a5'));
	sequencer.seq.setNote(1, _notes2.default.note('b4'));
	sequencer.seq.setNote(2, _notes2.default.note('c6'));
	sequencer.seq.setNote(3, _notes2.default.note('d5'));
	sequencer.seq.setNote(4, _notes2.default.note('e4'));
	sequencer.seq.setNote(5, _notes2.default.note('f6'));
	sequencer.seq.setNote(6, _notes2.default.note('g5'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.SequencerVolumeKnob = exports.SequencerNoteKnob = exports.DetuneKnob = exports.OctaveKnob = exports.ShapeKnob = exports.ReleaseKnob = exports.AttackKnob = undefined;
	...
	var _octave = __webpack_require__(18);

	var _octave2 = _interopRequireDefault(_octave);

	var _detune = __webpack_require__(19);

	var _detune2 = _interopRequireDefault(_detune);

	var _seqnote = __webpack_require__(20);

	var _seqnote2 = _interopRequireDefault(_seqnote);

	var _seqvolume = __webpack_require__(22);

	var _seqvolume2 = _interopRequireDefault(_seqvolume);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.AttackKnob = _attack2.default;
	exports.ReleaseKnob = _release2.default;
	exports.ShapeKnob = _shape2.default;
	exports.OctaveKnob = _octave2.default;
	exports.DetuneKnob = _detune2.default;
	exports.SequencerNoteKnob = _seqnote2.default;
	exports.SequencerVolumeKnob = _seqvolume2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AttackKnob = function (_Knob) {
	    _inherits(AttackKnob, _Knob);

	    function AttackKnob(canvas, voice) {
	        _classCallCheck(this, AttackKnob);

	        var _this = _possibleConstructorReturn(this, (AttackKnob.__proto__ || Object.getPrototypeOf(AttackKnob)).call(this, canvas, voice._name + ' Attack'));

	        _this.setRadius(20);
	        _this.setMinMax(30, 330);
	        _this.change(function (p) {
	            voice.setAttack(p * 4);
	        });
	        return _this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uiobj = __webpack_require__(12);
	...
	var Knob = function (_UIObj) {
	    _inherits(Knob, _UIObj);

	    function Knob(canvas) {
	        var title = arguments.length <= 1 || arguments[1] === undefined ? '' : arguments[1];

	        _classCallCheck(this, Knob);

	        var _this = _possibleConstructorReturn(this, (Knob.__proto__ || Object.getPrototypeOf(Knob)).call(this, canvas));
	        ...
	        // Title label
	        _this.titleLabel = new _label2.default(canvas).setColor('#fff').setOffset(_this, 0, _this._titleY).dynamicText(function () {
	            return _this._title;
	        });
	        return _this;
	    }
	    ...
	    _createClass(Knob, [{
	        ...
	        value: function draw() {
	            ...
	            var glowColor = this._disabled ? '#2d2d2d' : '#83d8ff';
	            var inactiveGlowColor = this._disabled ? '#2d2d2d' : '#19344c';
	            var whiteColor = this._disabled ? '#3c3c3c' : '#fff';
	            ...
	            var rAngle = _calc2.default.d2r(this._angle + 90);
	            ...
	            if (_.isArray(this._snaps)) {
	                ...
	                try {
	                    for (var _iterator = this._snaps[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                        var s = _step.value;

	                        this.ctx.fillStyle = s.active ? glowColor : whiteColor;
	                        this.ctx.shadowBlur = s.active ? 10 : 0;
	                        var safeAngle = _calc2.default.nd2r(s.angle);
	                        if (this._radius <= 15) {
	                ...
	                var safeMin = _calc2.default.nd2r(this._min);
	                var safeCurrent = _calc2.default.nd2r(this._angle);
	                var safeMax = _calc2.default.nd2r(this._max);
	                this.ctx.lineWidth = this._lineWidth;
	        ...
	        value: function hitBox(x, y) {
	            ...
	            return _calc2.default.hyp(deltax, deltay) <= this._radius + this._lineWidth;
	        }
	    }, {
	        key: 'setSnaps',
	        value: function setSnaps(arr, defaultValue, showText) {
	            var _this2 = this;
	            ...
	            if (!this._snaps[0].angle) this._snaps.forEach(function (s, i) {
	                s.angle = _this2._min + i * (_this2._max - _this2._min) / _this2._snaps.length;
	            });
	        ...
	        key: 'setRadius',
	        value: function setRadius(rad) {
	            this._radius = rad;
	            return this;
	        }
	    }, {
	        key: 'setTitleY',
	        value: function setTitleY(y) {
	            this._titleY = y;
	            return this;
	        }
	    }, {
	        ...
	        value: function mousemoveHandler(e) {
	            ...
	            if (e) this._angle = -1 * _calc2.default.r2d(Math.atan2(e.rx - this._x, e.ry - this._y));else {
	                if (this._snaps) {
	            ...
	            if (_.isArray(this._snaps)) {
	                ...
	                try {
	                    for (var _iterator2 = this._snaps[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	                        var a = _step2.value;
	                ...
	                if (!closest.active) {
	                    // Run its setter
	                    if (_.isFunction(closest.set)) closest.set();else this._changeFn(closest.value);
	                    ...
	                    try {
	                        for (var _iterator3 = this._snaps[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	                            var b = _step3.value;
	                            b.active = false;
	            ...
	            // Snap angle
	            if (this._min && this.angle < this._min) this.angle = this._min;else if (this._max && this.angle > this._max) this.angle = this._max;
	        }
	    }, {
	        key: 'mouseupHandler',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UIObj = function () {
	    function UIObj(canvas) {
	        _classCallCheck(this, UIObj);

	        this.id = _tool2.default.id();
	        this.canvas = canvas;
	        this.ctx = canvas.ctx;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tool = function () {
	    ...
	    _createClass(Tool, null, [{
	        ...
	        key: 'setAll',
	        value: function setAll(array, prop, value) {
	            array.map(function (o) {
	                return _lodash2.default.set(o, prop, value);
	            });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Label = function (_UIObj) {
	    _inherits(Label, _UIObj);

	    function Label(canvas) {
	        var title = arguments.length <= 1 || arguments[1] === undefined ? 'text' : arguments[1];
	        var size = arguments.length <= 2 || arguments[2] === undefined ? 12 : arguments[2];

	        _classCallCheck(this, Label);

	        // Set defaults
	        var _this = _possibleConstructorReturn(this, (Label.__proto__ || Object.getPrototypeOf(Label)).call(this, canvas));
	    ...
	    _createClass(Label, [{
	        ...
	        value: function draw() {
	            ...
	            if (!this._parent) this.ctx.fillText(this._dynamicText ? this._dynamicText() : this._text, this._x, this._y);else this.ctx.fillText(this._dynamicText ? this._dynamicText() : this._text, this._parent._x + this._offsetX, this._parent._y + this._offsetY);
	            this.ctx.closePath();
	        ...
	        key: 'setOffset',
	        value: function setOffset(parent, x, y) {
	            this._parent = parent;
	            this._offsetX = x;
	            this._offsetY = y;
	            return this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReleaseKnob = function (_Knob) {
	    _inherits(ReleaseKnob, _Knob);

	    function ReleaseKnob(canvas, voice) {
	        _classCallCheck(this, ReleaseKnob);

	        var _this = _possibleConstructorReturn(this, (ReleaseKnob.__proto__ || Object.getPrototypeOf(ReleaseKnob)).call(this, canvas, voice._name + ' Release'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ShapeKnob = function (_Knob) {
	    _inherits(ShapeKnob, _Knob);

	    function ShapeKnob(canvas, voice) {
	        _classCallCheck(this, ShapeKnob);

	        var _this = _possibleConstructorReturn(this, (ShapeKnob.__proto__ || Object.getPrototypeOf(ShapeKnob)).call(this, canvas, voice._name + ' Shape'));

	        _this.setRadius(20);
	        _this.setMinMax(30, 200);
	        _this.change(function (value) {
	            return voice.setWave(value);
	        });
	        _this.setSnaps([{
	            text: '◻',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OctaveKnob = function (_Knob) {
	    _inherits(OctaveKnob, _Knob);

	    function OctaveKnob(canvas, voice) {
	        _classCallCheck(this, OctaveKnob);

	        var _this = _possibleConstructorReturn(this, (OctaveKnob.__proto__ || Object.getPrototypeOf(OctaveKnob)).call(this, canvas, voice._name + ' Octave'));

	        _this.setRadius(15);
	        _this.setMinMax(40, 368);
	        _this.change(function (value) {
	            return voice.setOctave(value);
	        });
	        _this.setSnaps([{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DetuneKnob = function (_Knob) {
	    _inherits(DetuneKnob, _Knob);

	    function DetuneKnob(canvas, voice) {
	        _classCallCheck(this, DetuneKnob);

	        var _this = _possibleConstructorReturn(this, (DetuneKnob.__proto__ || Object.getPrototypeOf(DetuneKnob)).call(this, canvas, voice._name + ' Detune'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SequencerNoteKnob = function (_Knob) {
	    _inherits(SequencerNoteKnob, _Knob);

	    function SequencerNoteKnob(canvas, sequencer, step) {
	        var octave = arguments.length <= 3 || arguments[3] === undefined ? 5 : arguments[3];

	        _classCallCheck(this, SequencerNoteKnob);

	        var _this = _possibleConstructorReturn(this, (SequencerNoteKnob.__proto__ || Object.getPrototypeOf(SequencerNoteKnob)).call(this, canvas, 'Step ' + (step + 1)));

	        var defaultNote = sequencer.seq.getNote(step);
	        _this.setRadius(15);
	        _this.change(function (v) {
	            sequencer.seq.setNote(step, _notes2.default.note(v, defaultNote.octave));
	        });
	        _this.setSnaps([{
	            value: 'a',
	            text: 'a'
	    ...
	    return SequencerNoteKnob;
	}(_knob2.default);

	exports.default = SequencerNoteKnob;
	...
	var Notes = function () {
	    ...
	    _createClass(Notes, null, [{
	        ...
	        value: function setup() {
	            ...
	            function _genOctaves() {
	                var num = arguments.length <= 0 || arguments[0] === undefined ? 6 : arguments[0];
	        ...
	        key: 'transpose',
	        value: function transpose(note, delta) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SequencerVolumeKnob = function (_Knob) {
	    _inherits(SequencerVolumeKnob, _Knob);

	    function SequencerVolumeKnob(canvas, sequencer, step) {
	        var value = arguments.length <= 3 || arguments[3] === undefined ? 1 : arguments[3];

	        _classCallCheck(this, SequencerVolumeKnob);

	        var _this = _possibleConstructorReturn(this, (SequencerVolumeKnob.__proto__ || Object.getPrototypeOf(SequencerVolumeKnob)).call(this, canvas, 'Volume'));
	    ...
	    return SequencerVolumeKnob;
	}(_knob2.default);

	exports.default = SequencerVolumeKnob;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Canvas = function () {
	    function Canvas(id) {
	        ...
	        try {
	            for (var _iterator = capture[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                var eventName = _step.value;
	                this.elem.addEventListener(eventName, this[eventName + 'Handler'].bind(this));
	            } // Window mouseup
	        } catch (err) {
	            _didIteratorError = true;
	            _iteratorError = err;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _audioobj = __webpack_require__(25);

	var _audioobj2 = _interopRequireDefault(_audioobj);
	...
	var Voice = function (_AudioObj) {
	    _inherits(Voice, _AudioObj);

	    function Voice(actx, name) {
	        _classCallCheck(this, Voice);

	        // Main oscillator
	        var _this = _possibleConstructorReturn(this, (Voice.__proto__ || Object.getPrototypeOf(Voice)).call(this, actx, name));

	        _this.osc = actx.createOscillator();
	        _this.osc.start();

	        // Amplifier
	        _this.vca = _this.ctx.createGain();
	        _this.vca.gain.value = 0;
	        _this.osc.connect(_this.vca);
	    ...
	    _createClass(Voice, [{
	        ...
	        key: 'setFreqEnvelope',
	        value: function setFreqEnvelope(env, tc) {
	        ...
	        value: function setNote(note) {
	            ...
	            // Transpose note
	            note = _notes2.default.transpose(note, this._octave * 12 + this._transpose);
	        ...
	        key: 'setOctave',
	        value: function setOctave(oct) {
	            this._octave = _.clamp(oct, 0, 11);
	            return this;
	        }
	    }, {
	        key: 'upOctave',
	        value: function upOctave() {
	        ...
	        key: 'setTranspose',
	        value: function setTranspose(delta) {
	            this._transpose = _.clamp(delta, -11, 12);
	            return this;
	        }
	    }, {
	        key: 'upTranspose',
	        value: function upTranspose() {
	            this._transpose = _.clamp(this._transpose + 1, -11, 12);
	        }
	    }, {
	        key: 'downTranspose',
	        value: function downTranspose() {
	            this._transpose = _.clamp(this._transpose - 1, -11, 12);
	        }
	        ...
	        key: 'setAttack',
	        value: function setAttack(t) {
	            this._attack = t;
	            return this;
	        }
	    }, {
	        key: 'setRelease',
	        value: function setRelease(t) {
	            this._release = t;
	            return this;
	        }
	        ...
	        key: 'connectOscilloscope',
	        value: function connectOscilloscope(scope) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AudioObj = function AudioObj(actx, name) {
	    _classCallCheck(this, AudioObj);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Oscilloscope = function (_UIObj) {
	    _inherits(Oscilloscope, _UIObj);

	    function Oscilloscope(canvas, audioContext, voices) {
	        _classCallCheck(this, Oscilloscope);

	        // Setup defaults
	        var _this = _possibleConstructorReturn(this, (Oscilloscope.__proto__ || Object.getPrototypeOf(Oscilloscope)).call(this, canvas));

	        _this._actx = audioContext;
	        _this._width = 200;
	        _this._height = 100;

	        // Set up scope (fft, data stuffs.)
	        _this._oScope = _this._actx.createAnalyser();
	        _this._oScope.fftSize = 2048;
	        _this._dataArray = new Uint8Array(_this._oScope.frequencyBinCount);

	        // Loop through the voices and connect to the scope.
	        voices.forEach(function (voice) {
	            return voice.connectOscilloscope(_this._oScope);
	        });
	        return _this;
	    }
	    ...
	    _createClass(Oscilloscope, [{
	        ...
	        value: function draw() {
	            ...
	            for (var i = 0; i < this._oScope.frequencyBinCount; i++) {
	                var sliceY = (this._dataArray[i] + 128) / 256 * this._height / 2;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sequencer = function () {
	    ...
	    _createClass(Sequencer, [{
	        ...
	        key: 'setSequence',
	        value: function setSequence(num) {
	...
	var Sequence = function () {
	    ...
	    _createClass(Sequence, [{
	        key: 'setNote',
	        value: function setNote(step, note) {
	            console.log(step);
	        ...
	        key: 'setVolume',
	        value: function setVolume(step, volume) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Keys = function (_UIObj) {
	    _inherits(Keys, _UIObj);

	    function Keys(canvas) {
	        _classCallCheck(this, Keys);

	        // Setup defaults
	        var _this = _possibleConstructorReturn(this, (Keys.__proto__ || Object.getPrototypeOf(Keys)).call(this, canvas));
	        ...
	        _this._height = 100;
	        _this._width = 500;
	        _this.keyWidth = _this._width / 12;
	        _this.octaves = _notes2.default.all;
	        return _this;
	    }
	    ...
	    _createClass(Keys, [{
	        ...
	        value: function draw() {
	            ...
	            this.octave.forEach(function (o, i) {
	                ...
	                _this2.ctx.fillStyle = o.active ? '#044' : o.note.length > 1 ? '#022' : '#033';
	                _this2.ctx.fillRect(_this2._x + i * _this2.keyWidth, _this2._y, _this2.keyWidth, _this2.keyWidth * 5);
	                _this2.ctx.rect(_this2._x + i * _this2.keyWidth, _this2._y, _this2.keyWidth, _this2.keyWidth * 5);
	                _this2.ctx.stroke();
	        ...
	        value: function mousemoveHandler(e) {
	            ...
	            var note = this.octave[Math.floor((e.rx - this._x) / this.keyWidth)];
	            note.active = true;
	            this.setNote(note);
	        }
	    }, {
	        ...
	        value: function resetKeys() {
	            ...
	            _tool2.default.setAll(this.octave, 'active', false);
	        }
	    }, {
	        key: 'attach',
	        value: function attach(voice) {
	            this.voices.push(voice);
	            return this;
	        }
	    }, {
	        key: 'detach',
	        value: function detach(voice) {
	        ...
	        key: 'setNote',
	        value: function setNote(note) {
	            this.voices.map(function (o) {
	                return o.setNote(note);
	            });
	        }
	    }, {
	        key: 'playNote',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Led = function (_UIObj) {
	    _inherits(Led, _UIObj);

	    function Led(canvas, title) {
	        _classCallCheck(this, Led);

	        // Set to default
	        var _this = _possibleConstructorReturn(this, (Led.__proto__ || Object.getPrototypeOf(Led)).call(this, canvas));
	    ...
	    _createClass(Led, [{
	        ...
	        value: function draw() {
	            ...
	            // Create glow
	            var grd = this.ctx.createRadialGradient(this._x, this._y, 2, this._x + 2, this._y + 2, 5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Switch = function (_UIObj) {
	    _inherits(Switch, _UIObj);

	    function Switch(canvas, title, options) {
	        var numPositions = arguments.length <= 3 || arguments[3] === undefined ? 2 : arguments[3];
	        var default_position = arguments.length <= 4 || arguments[4] === undefined ? 2 : arguments[4];

	        _classCallCheck(this, Switch);

	        var _this = _possibleConstructorReturn(this, (Switch.__proto__ || Object.getPrototypeOf(Switch)).call(this, canvas));

	        _this._numPositions = numPositions;
	        _this._title = title;
	        _this._width = 15;
	        _this._height = 30;
	        _this._handleHeight = _this._height / _this._numPositions;
	        _this._position = default_position;
	        ...
	        // Title label
	        _this.titleLabel = new _label2.default(canvas).setOffset(_this, _this._width / 2, 59).dynamicText(function () {
	            return _this._title;
	        });

	        // On Label
	        _this.onLabel = new _label2.default(canvas).setSize(8).setOffset(_this, _this._width + 10, _this._y).dynamicText(function () {
	            return _this._options.on.text;
	        });

	        // Middle Label
	        _this.middleLabel = new _label2.default(canvas).setSize(8).setOffset(_this, _this._width + 10, _this._height / 2 + 2).dynamicText(function () {
	            return _this._options.mid.text;
	        });

	        // Off Label
	        _this.offLabel = new _label2.default(canvas).setSize(8).setOffset(_this, _this._width + 10, _this._height + 5).dynamicText(function () {
	            return _this._options.off.text;
	        });
	        return _this;
	    }
	    ...
	    _createClass(Switch, [{
	        ...
	        value: function mousemoveHandler(e) {
	            ...
	            // Set handle position
	            if (e.ry < this._y + this._height / this._numPositions) this._position = 2;else if (this._numPositions == 3 && e.ry < this._y + 2 * this._height / 3) this._position = 1;else this._position = 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rectangle = function (_UIObj) {
	    _inherits(Rectangle, _UIObj);

	    function Rectangle(canvas, width, height) {
	        var radius = arguments.length <= 3 || arguments[3] === undefined ? 5 : arguments[3];
	        var fill = arguments.length <= 4 || arguments[4] === undefined ? false : arguments[4];

	        _classCallCheck(this, Rectangle);

	        // Set defaults
	        var _this = _possibleConstructorReturn(this, (Rectangle.__proto__ || Object.getPrototypeOf(Rectangle)).call(this, canvas));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Oscillator = function () {
	    function Oscillator(canvas, voice) {
	        var _this = this;

	        var title = arguments.length <= 2 || arguments[2] === undefined ? 'OSC' : arguments[2];
	        ...
	        this._titleLabel = new _label2.default(canvas, this._title, 14).setAlign('left').setColor('#bfbfbf');
	        this._rect = new _rectangle2.default(canvas, 490, 105, 5).setColor('#403c3c');
