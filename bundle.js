        ...
        var Knob = function(_UIObj) {
            ...
            _createClass(Knob, [{
                ...
                value: function mousemoveHandler(e) {
                    ...
                    if (e) this._angle = -1 * _calc2.default.r2d(Math.atan2(e.rx - this._x, e.ry - this._y));
                    else {
                        if (this._snaps) {
        ...
        var Label = function(_UIObj) {
            ...
            _createClass(Label, [{
                ...
                value: function draw() {
                    ...
                    if (!this._parent) this.ctx.fillText(this._dynamicText ? this._dynamicText() : this._text, this._x, this._y);
                    else this.ctx.fillText(this._dynamicText ? this._dynamicText() : this._text, this._parent._x + this._offsetX, this._parent._y + this._offsetY);
                    this.ctx.closePath();
