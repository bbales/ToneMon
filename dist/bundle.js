...
/***/ function(module, exports, __webpack_require__) {
	...
	var _knob = __webpack_require__(4);
	...
	var _led = __webpack_require__(11);
	...
	var keys = new _keys2.default(canvas);

	// Audio
	var actx = new window.AudioContext();
	var v1 = new _voice2.default(actx);
	v1.setWave('sine').setFreqEnvelope('tween', 0.001).setOctave(2);
	keys.attach(v1);

	var k1 = new _knob2.default(canvas, 'OSC1 Shape');
	...
	var osc1_atk = new _knob2.default(canvas, 'OSC1 Attack');
	osc1_atk.setPos(300, 150).setRadius(20).setMinMax(30, 330).change(function (p) {
	    console.log(p);
	    v1.setAttack(p * 4);
	});

	var osc1_rel = new _knob2.default(canvas, 'OSC1 Release');
	...
	for (var i = 0; i < 5; i++) {
	    var led1 = new _led2.default(canvas);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uiobj = __webpack_require__(5);
	...
	var Knob = function (_UIObj) {
	    ...
	    _createClass(Knob, [{
	        ...
	        key: 'setSnaps',
	        value: function setSnaps(arr, showText) {
	        ...
	        value: function mousemoveHandler(e) {
	            ...
	            if (e) this._angle = -1 * _calc2.default.r2d(Math.atan2(e.pageX - this._x, e.pageY - this._y));else {
	                if (this._snaps) {
	    ...
	    _createClass(Canvas, [{
	        ...
	        value: function mousedownHandler(e) {
	            this.objs.map(function (o) {
	                return o.mousedownHandler.bind(o, e)();
	            });
	        }
	    }, {
	        key: 'mouseupHandler',
	        value: function mouseupHandler(e) {
	            this.objs.map(function (o) {
	                return o.mouseupHandler.bind(o, e)();
	            });
	        }
	    }, {
	        key: 'mousemoveHandler',
	        value: function mousemoveHandler(e) {
	            this.objs.map(function (o) {
	                return o.mousemoveHandler.bind(o, e)();
	            });
	        }
	    }, {
	        key: 'redraw',
...
/***/ function(module, exports) {
	...
	var _noteArray = void 0;
	var _flatArray = void 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Led = function (_UIObj) {
	    ...
	    function Led(canvas, title) {
	        ...
	        _this._color1 = '#d432d4';
	        _this._color2 = '#ffbbf9';

	        _this._colorOff1 = '#212121';
	        _this._colorOff2 = '#5a5a5a';
	        return _this;
	    }
